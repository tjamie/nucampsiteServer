...
campsiteRouter
    ...
    .put(cors.corsWithOptions, authenticate.verifyUser, authenticate.verifyAdmin, (req, res) => {
        res.statusCode = 403;
        res.end("PUT not supported for /campsites");
    })
...
campsiteRouter
    ...
    .put(cors.corsWithOptions, authenticate.verifyUser, authenticate.verifyAdmin, (req, res) => {
        res.statusCode = 403;
        res.end(`PUT not supported for /campsites/${req.params.campsiteId}/comments`);
    })
    .delete(cors.corsWithOptions, authenticate.verifyUser, authenticate.verifyAdmin, (req, res, next) => {
        Campsite.findById(req.params.campsiteId)
            .then((campsite) => {
...
campsiteRouter
    ...
    .post(cors.corsWithOptions, authenticate.verifyUser, authenticate.verifyAdmin, (req, res) => {
        Campsite.findById(req.params.campsiteId);
        res.statusCode = 403;
        res.end(`POST not supported for /campsites/${req.params.campsiteId}/comment/${req.params.commentId}`);
    })
